...
const u8 aau8BlackSquare[U8_LCD_IMAGE_ROW_SIZE_50PX][U8_LCD_IMAGE_COL_BYTES_50PX] = {
    {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x03},
    {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x03},
    {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x03},
    {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x03},
...
const u8 aau8BlackBox[(u8)14][((u8)14 * (u8)1 / 8 + 1)] = {
    {0xFF, 0x3F},
    {0xFF, 0x3F},
    {0xFF, 0x3F},
    {0xFF, 0x3F},
...
const u8 aau8CrossOut[(u8)14][((u8)14 * (u8)1 / 8 + 1)] = {
    {0x01, 0x20},
    {0x02, 0x10},
    {0x04, 0x08},
    {0x08, 0x04},
...
const u8 aau8Target[(u8)14][((u8)14 * (u8)1 / 8 + 1)] = {
    {0x00, 0x00},
    {0xFA, 0x17},
    {0x04, 0x08},
    {0xFA, 0x17},
